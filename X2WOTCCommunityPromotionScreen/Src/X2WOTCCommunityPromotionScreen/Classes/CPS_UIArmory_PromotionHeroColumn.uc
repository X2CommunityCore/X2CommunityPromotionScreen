//---------------------------------------------------------------------------------------
//  FILE:    CPS_UIArmory_PromotionHeroColumn.uc
//  AUTHORS: Tzarnal - MoonWolf, Peter Ledbrook
//  PURPOSE: Replaces promotion screen columns for improved layout.
//---------------------------------------------------------------------------------------
class CPS_UIArmory_PromotionHeroColumn extends UIArmory_PromotionHeroColumn;

var int Offset;

// Start Issue #13 - modify columns to be slightly narrower to fit
// a shorter promotion screen overall.
